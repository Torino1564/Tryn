...
namespace tryn::ser
{
	void SerializeWrite(const StreamWriter& sw, const scr::PinInfo& data, const bool binary, const std::string& name)
	{
	...
	void SerializeRead(const StreamReader& sr, scr::PinInfo& data, const bool binary, ExtraDataPack* pExtraData)
	{
