...
namespace tryn::gfx
{
	ForwardFlat::ForwardFlat(Material& material, aiMaterial& aiMat, IGraphics& gfx, const std::string& rootPath, bool instanced, bool skinned)
		:
		Technique("ForwardFlat")
	{
		...
		Step step("LambertianFlat", "LambertianFlat");
		gfx.GetRenderGraph().AddRenderQueue("LambertianFlat");
