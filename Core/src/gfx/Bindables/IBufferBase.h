...
namespace tryn::gfx
{
	...
	public:
		...
		static std::shared_ptr<IVertexBuffer> Resolve(const IGraphics& gfx, std::shared_ptr<VertexBuffer> cpuBuffer, std::string tag = "?")
		...
		VertexLayout& GetLayout() requires (Type == BufferType::Vertex);
