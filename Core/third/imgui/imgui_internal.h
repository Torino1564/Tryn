...
struct ImGuiLastItemData;           // Status storage for last 
...
//#endif
    ...
    IMGUI_API void          RenderMouseCursor(ImVec2 pos, float 
        
        
        , ImGuiMouseCursor mouse_cursor, ImU32 col_fill, ImU32 col_border, ImU32 col_shadow);
