...
TestApp::TestApp(std::shared_ptr<win::IWindow> wnd, std::shared_ptr<gfx::IGraphics> gfx)
{
	...
	sponza.GetComponent<ecs::cmp::ModelComponent>().pModel = std::unique_ptr<gfx::Model>(gfx::Model::MakeNew(Gfx(), "resources/models/Sponza/sponza.obj"));
	...
	entParent.GetComponent<ecs::cmp::InstancedModelParentComponent>().parentModel = gfx::InstancedModelParent::Make(Gfx(), "resources/models/gobber/GoblinX.obj");
	...
	testTerrain.GetComponent<ecs::cmp::ModelComponent>().pModel = std::unique_ptr<gfx::Model>(gfx::Model::MakeNew(Gfx(), "resources/models/TestTerrain.obj"));
